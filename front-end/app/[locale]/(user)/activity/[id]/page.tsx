...
const Lesson = async ({ params }: Params) => {
    ...
    <div>
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          <h1 className="text-2xl font-semibold">Homework Activities</h1>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-600 font-normal">
            Practice conversations about environmental issues, listen to nature
            documentaries, and discuss solutions for climate change.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-gray-600">
            Read articles about environmental policies, write essays on
            conservation, and analyze environmental data and reports.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-2 shadow-lg border-slate-100 border p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-600">
            Read articles about environmental policies, write essays on
            conservation, and analyze envir onmental data and reports.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 pt-4 justify-center w-full items-center">
          <Link
            ...
            className={buttonVariants({
              variant: "secondary",
              className:
                "w-full text-lg leading-6 h-auto! rounded-full bg-gradient-to-b! from-orange-400 to-orange-600 text-white max-w-sm",
            })}
          >
            Homework Activities
          </Link>
          <Button
            variant="outline"
            className="w-full rounded-full max-w-sm text-lg leading-6 h-auto!"
          >
            Study Again
          </Button>
        </div>
